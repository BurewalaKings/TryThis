...
\033[1;92m ┈┈┈▕▕╲┊┊╱▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕╲┊┊╱▏▏┈┈┈
\033[1;92m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
\033[1;92m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈\033[1;96mBurewala Kings\033[1;91m┈┈┈┈╲┊┊┊┊╱┈┈┈┈
\033[1;92m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;92m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
\033[1;92m................\033[1;96mBurewala Kings\033[1;91m...............
...
\033[1;91m☞ Auther     : SK-Productions✅
\033[1;92m☞ Facebook   : Sk-Productions
\033[1;95m☞ YouTube    : Sk Production
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update Burewala Kings Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' Burewala Kings')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/burewala-kings')
	    os.system('cd $HOME && git clone https://github.com/BurewalaKings/TryThis/')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('facebook id ✓')
	    psb('WellCome To Burewala Kings')
	    psb('Congratulations Burewala Kings Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ xidi✓')
	    psb('🔓Password ☆ pakistani✓')
	    psb('Subscrib My Youtube Chennal xidi pakistani✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/BurewalaKings && python2 SkProducts.py')
	elif bm =='3':
	    os.system('xdg-open https://www.youtube.com/channel/UC86WWYVWtKQj2h4KPc9GlqA')
	    menu()
	elif bm =='4':
...
def pb():
	...
	print(S+'Burewala Kings')     
	print
	raw_input(R + 'Back')
	os.system('python2 SkProduct.py')
